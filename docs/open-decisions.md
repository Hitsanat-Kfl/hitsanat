...
- **Decision Status:** `RESOLVED (Adopted Option A)` — decided 2026-09-23. "Permission overrides" in the persona table is interpreted as the documented SUPER_ADMIN bypass (roles-and-permissions.md § 4.3). The Permission Matrix page remains a static reference view (FR-13.3) rendered from `packages/permissions` matrix data.
